  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-950">
      <section className="max-w-[1024px] mx-auto items-center">
        <div className="flex justify-center items-center md:justify-start md:items-start py-5">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 w-full max-w-screen-lg">
